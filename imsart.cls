...
\ProvidesClass{imsart}[2020/04/06 driver class for package imsart.sty]
...
\ifdefined\loadamssymboptions\else
 \def\loadamssymboptions{\PassOptionsToPackage{psamsfonts}{amssymb}}
\fi
